...
// Initialize the map with D3.js and TopoJSON
function initMap() {
    ...
    // Set up projection (Albers USA projection for US maps)
    ...
    fetch('https://cdn.jsdelivr.net/npm/us-atlas@3/states-10m.json')
        ...
        .catch(error => {
            ...
            container.innerHTML = '<p style="color: red; text-align: center; padding: 40px;">Error loading map. Please refresh the page.</p>';
        });
}
